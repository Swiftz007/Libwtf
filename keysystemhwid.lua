--[[
    ===================================================
    REAPER HUB | KEY SYSTEM - ROUNDED SQUARE LOGO UI
    ===================================================
]]--
...
MainFrame.BackgroundColor3 = Color3.fromRGB(6, 9, 17) -- พื้นหลังมืดสไตล์เว็บ
...
UIStroke.Color = Color3.fromRGB(239, 68, 68) -- #ef4444 (Reaper Red)
...
LogoCorner.CornerRadius = UDim.new(0, 12) -- ปรับความโค้งมนของสี่เหลี่ยมโลโก้ตรงนี้
...
-- ปุ่ม Verify Button (โทนสีแดงสดเข้ากับธีม)
...
GetKeyBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        ...
        StatusLabel.Text = "Status: Copied Link"
...
VerifyBtn.MouseButton1Click:Connect(function()
    ...
    if userKey == "" or userKey == " " then
        StatusLabel.Text = "Status: Please enter key first!"
        StatusLabel.TextColor3 = Color3.fromRGB(248, 113, 113)
        return
    end
    ...
    -- ===============================================
    loadstring(game:HttpGet("https://projectlua.netlify.app"))()
    -- ===============================================
end)
